...
- [ ] **3.1** Centralize domain enums *(Agent A: SSOT-001)*
...
- [ ] **3.2** Unify `ActionResponse` *(Agent A: SSOT-002)*
...
- [ ] **3.3** Deduplicate currency formatting *(Agent A: SSOT-003)*
...
- [ ] **3.4** Type-safe settings keys *(Agent A: SSOT-004)*
...
- [ ] **3.5** Centralize business policy constants *(Agent A: HC-003)*
...
- [ ] **3.6** Externalize PDF bank/company fallbacks *(Agent A: HC-002)*
