...
- [ ] **4.1** Zod-parse all server action inputs *(Agent A: BL-004)*
...
- [ ] **4.2** Validate UUID parameters everywhere *(Agent A: BL-005)*
...
- [ ] **4.3** Block quote reopening after project conversion *(Agent A: BL-001)*
...
- [ ] **4.4** Unique constraint on `projects.quotation_id` *(Agent A: BL-002)*
...
- [ ] **4.5** Idempotent project completion *(Agent A: BL-003)*
