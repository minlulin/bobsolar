...
- [x] **6.1** Enable missing strict compiler flags _(Agent A: TS-001)_
  - **File**: `tsconfig.json`
...
- [x] **6.2** Split service-worker tsconfig _(Agent A: TS-003)_
...
- [x] **6.3** Fix local strict-pass violations _(Agent A: TS-002)_
...
- [x] **6.4** Remove unsafe casts and non-null assertions _(Agent A: TS-004)_
...
- [x] **6.5** Pin TypeScript version _(Agent A: DEPLOY-002)_
  - **File**: `package.json`
