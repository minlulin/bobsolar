...
export default function LedgerError({
  ...
  useEffect(() => {
    console.error("[Ledger Error Boundary]", error);
  }, [error]);
  ...
  return (
    <div className="flex h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h2 className="text-foreground mb-2 text-2xl font-bold">Ledger Error</h2>
      <p className="text-muted-foreground mb-8 max-w-md">
        We encountered an error loading the general ledger. This could affect financial reporting.
