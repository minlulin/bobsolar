...
export default function CashMovementError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[Cash Movement Report Error]", error);
  }, [error]);
  ...
  return (
    <div className="flex h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <p className="text-muted-foreground mb-8 max-w-md">
        We encountered an error loading the cash movement report. Please try again or contact
