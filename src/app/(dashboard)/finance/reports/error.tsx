  ...
  return (
    <div className="flex h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <p className="text-muted-foreground mb-8 max-w-md">
        We encountered an error generating financial reports. This could affect your financial
        analysis. Please try again or contact support if the issue persists.
      </p>
