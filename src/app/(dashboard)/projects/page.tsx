  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          <h1 className="font-heading text-3xl font-bold tracking-tighter">Active projects</h1>
          <p className="text-muted-foreground max-w-xl text-sm leading-relaxed">
            Each card syncs quotations, budgeting, crews, and aftercare touchpoints — orbit through
            status chips to tighten your focus radius.
          </p>
