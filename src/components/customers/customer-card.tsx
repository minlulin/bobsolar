...
export function CustomerCard({ customer, onEdit, onDelete }: CustomerCardProps): React.JSX.Element {
  ...
  return (
    ...
    >
      <Card
        className="surface-panel group hover:border-primary/30 relative cursor-pointer rounded-2xl border transition-colors focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/40"
        role="button"
        tabIndex={0}
        onClick={() => {
          ...
          <div className="mt-3 grid gap-2">
            {customer.email && (
              <div className="text-muted-foreground flex items-center gap-3 text-xs">
                <div className="bg-muted/55 flex h-5 w-5 items-center justify-center rounded">
            ...
            {customer.address && (
              <div className="text-muted-foreground flex items-start gap-3 text-xs">
                <div className="bg-muted/55 mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded">
