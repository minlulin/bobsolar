...
export const ProjectCard = React.memo(function ProjectCard({
  ...
  return (
    <div className="transition-colors">
      <Card className="surface-panel group hover:border-primary/30 rounded-2xl border transition-colors">
        <CardContent className="relative space-y-4 p-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <Link
                href={`${hrefBase}/${project.id}`}
                className="font-heading text-foreground hover:text-solar text-sm font-semibold tracking-[0.12em] uppercase transition-colors"
              >
            ...
            <div className="flex flex-wrap justify-end gap-2">
              <Badge
                className={cn(
                  "border px-2 text-[10px] font-semibold uppercase",
          ...
          <div className="grid gap-3 text-xs md:grid-cols-3">
            <div>
              <p className="text-muted-foreground mb-0.5 text-[9px] font-bold tracking-[0.18em] uppercase">
                System size
              </p>
            ...
            <div>
              ...
              <p className="text-xs leading-relaxed">
                {format(new Date(project.startDate ?? project.createdAt), "MMM d")} to{" "}
