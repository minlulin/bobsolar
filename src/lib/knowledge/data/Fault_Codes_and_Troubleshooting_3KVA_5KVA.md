# Felicity IVEM-LV Series (3KVA~5KVA) — Diagnostic, Warning & Fault Codes

## Models Covered

| Model | Rated Power | Battery Voltage |
|---|---|---|
| **IVEM3048-LV** | 3000VA / 3000W | 48V |
| **IVEM5048-LV** | 5000VA / 5000W | 48V |
...
| Code | Fault Description | Troubleshooting |
|---|---|---|
| **—** | BMS communication fault | Check if the communication line is connected well. |
...
| **32** | Over temperature happen at PV circuit | Check air flow of the unit is not blocked and ambient temperature is not too high. |
...
| Code | Fault Description | Troubleshooting |
|---|---|---|
| **04** | Fan is locked (left) | Check if wiring is connected well. Replace the fan. |
| **—** | Fan is locked (right) | Check if wiring is connected well. Replace the fan. |

### 3.9 Communication & Parallel System Faults
...
## 4. Power Limitation (Low Battery Derating)

| Condition | Behavior |
|---|---|
| Battery voltage is lower than **48Vdc** | Output power will be derated |
| Connected load is higher than derated power | AC output voltage will decrease until output power reduces to derated power |
| Minimum AC output voltage | 90V |

---

## 5. Default Settings & Parameters

| Setting | Range / Default |
|---|---|
| AC Output Voltage | 110V / 120V / 127V (configurable) |
| Max. Charge Current (3KVA) | 10A–60A (1A increments), Default: 30A |
| Max. Charge Current (5KVA) | 10A–100A (1A increments), Default: 60A |
| Max. Discharge Current (3KVA) | 10A–60A (1A increments) |
| Max. Discharge Current (5KVA) | 10A–100A (1A increments) |
| PV Voltage Range | 90V–500V |
| Grid Feed-in | Selectable: Not allowed / Allowed |

---

## 6. BMS Communication Port Pin Assignment (RJ45)

*(Refer to 6KVA model documentation — pinout is standard for Felicitysolar BMS communication)*
...
## 7. Recommended AC Input Breaker

| Model | Maximum Bypass Input Current | Recommended Air Switch / Breaker |
|---|---|---|
| **3KVA (IVEM3048-LV)** | 40A | 2P-40A |
| **5KVA (IVEM5048-LV)** | 63A | 2P-63A |
