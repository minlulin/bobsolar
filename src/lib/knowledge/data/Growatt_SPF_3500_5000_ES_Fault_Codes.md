# Growatt SPF 3500 ES / SPF 5000 ES - Fault Codes and Troubleshooting

Official source: [Growatt SPF 3500 ES / SPF 5000 ES user manual](https://de.growatt.com/upload/file/SPF_3500-5000_ES_Benutzerhandbuch_DE_202109.pdf), pages 38-46. The source manual is German; descriptions below are faithful English translations.
...
| 61 | PV voltage too high | Isolate PV and verify array open-circuit voltage is within the inverter limit before reconnecting. |
...
| 17 | Parallel output phase loss | One beep per second; verify parallel mode settings and that every phase inverter is powered. |
...
To restart this family, disconnect all power sources. Wait until the LCD backlight is off, then boot using battery power only. Do not open the inverter enclosure; internal capacitors can retain dangerous voltage.
